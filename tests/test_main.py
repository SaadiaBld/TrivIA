...
boardgame = Board(12, 12)  # Création d'une instance de Board avec une grille de 12x12
player1 = Player(0, boardgame)
boardgame.create_boardgame()
print(player1.choose_move())  # Appel de la méthode choose_move pour voir le déplacement
print(player1.show_score()) 